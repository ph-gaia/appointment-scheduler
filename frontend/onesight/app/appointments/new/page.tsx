...
export default function NewAppointmentPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('http://localhost:8080/api/appointments', {
        ...
        body: JSON.stringify({ title: title, description: description, dateTime: date }),
      });
  ...
  return (
    <div className="max-w-lg mx-auto bg-white p-6 shadow-lg rounded-lg">
      <h1 className="text-2xl font-bold text-gray-600 mb-6 text-center">Create New Appointment</h1>
      <form className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 text-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
